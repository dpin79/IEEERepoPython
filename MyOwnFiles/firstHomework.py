###HECHO POR DANIEL PIÑEROS
###GITHUB @dpin79
###correo institucional: d.pinerosm@uniandes.edu.co
...
#print(pendBills(dictExample))      #ELIMINAR NUMERAL PARA PROBAR EL PROGRAMA EN LA FUNCIÓN ANTERIOR
...
#print(dbGestor(dataBaseExample))       #ELIMINAR NUMERAL PARA PROBAR EL PROGRAMA EN LA FUNCIÓN ANTERIOR