"""
Shows the user the number of points accumulated within the following sentence:
...
print(f'''You have earned {new_points} points! In total, you accumulate {total_points}
points''')